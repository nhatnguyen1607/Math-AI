...
const AdminWorksheetEditorPage = ({ user, onSignOut }) => {
  ...
  }, [worksheetType, navigate, worksheetId, loadWorksheetData]);
            ...
            <div className="mb-8">
              ...
              <div className="mb-3 flex flex-wrap gap-2">
                <button
                  ...
                  className="px-3 py-1 bg-blue-100 hover:bg-blue-200 text-blue-700 font-semibold rounded text-sm transition-all duration-300"
                  title="Chèn phân số"
                >
                  ➕ Phân số
                </button>
              ...
              <textarea
                ...
                rows="4"
                placeholder="Nhập câu hỏi chung cho phiếu bài tập (VD: Tính 1/2 + 3/4 = ?)"
              />
              
              <p className="mt-2 text-xs text-gray-500">
                💡 Gợi ý: Nhấp nút "Phân số" để nhập tử số và mẫu số
              </p>
            </div>
            ...
            {showFractionDialog && (
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div className="bg-white rounded-lg shadow-2xl p-6 max-w-sm w-full mx-4">
                  <h3 className="text-xl font-bold text-gray-800 mb-4">Nhập phân số</h3>
                  ...
                  <div className="flex gap-3">
                    <button
                      ...
                      className="flex-1 px-4 py-2 bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold rounded-lg transition-all duration-300"
                    >
                      Hủy
                    </button>
                    <button
                      ...
                      className="flex-1 px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white font-semibold rounded-lg transition-all duration-300"
                    >
                      Chèn
                    </button>
                  </div>
